...
- Port already in use:
  - Edit `deploy/docker-compose.yml` and change `5080:5000` to another host port, e.g. `5081:5000`.
- Container not starting:
  - Run `cd deploy && docker compose logs --tail=100`.
- Need to stop:
