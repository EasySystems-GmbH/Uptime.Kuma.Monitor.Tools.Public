...
- Install with `apps/synology-monitor/install.sh` or run `python3 synology-monitor.py` directly on DSM.
- Validate Task Scheduler integration and token settings.
