...
- **Latest release:** `https://github.com/EasySystems-GmbH/Uptime.Kuma.Monitor.Tools.Public/releases/latest/download/synology-monitor-basic.spk`
- **All releases:** `https://github.com/EasySystems-GmbH/Uptime.Kuma.Monitor.Tools.Public/releases`
