...
<body data-ui-view="{html.escape(ui_view)}" data-diag-view="{html.escape(diag_label)}" data-log-filter="{html.escape(filter_label)}" data-log-date="{html.escape(log_date_norm)}" data-log-time-scope="{html.escape(log_time_norm)}" data-log-time-from="{html.escape(log_time_from_norm)}" data-log-time-to="{html.escape(log_time_to_norm)}" data-log-source="{html.escape(source_label)}" data-form-error="{('1' if error and modal_open else '0')}" data-monitor-modal-open="{('1' if modal_open else '0')}">
      ...
      function _updatePageFromResponse(txt) {{
        ...
        if (newContainer && curContainer) {{
          ...
          if (newBody) {{
            ...
            ["data-ui-view", "data-diag-view", "data-log-filter", "data-log-date", "data-log-time-scope", "data-log-time-from", "data-log-time-to", "data-log-source", "data-form-error", "data-monitor-modal-open"].forEach(function(attr) {{
